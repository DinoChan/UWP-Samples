...
namespace ShapeDemo
{
    public class Triangle : Path
    {
        ...
        ///     此对象可以提供给子对象的可用大小。可以将值指定为无穷大 (<see cref="F:System.Double.PositiveInfinity" />
        ///     )，以指明对象大小将调整为可用的任何内容的大小。
        /// </param>
        /// <remarks>
        ///     在 WPF 中，测量值替代利用 Shape.DefiningGeometry 进行工作，Shape.DefiningGeometry 并不始终跟预计的一样。有关详细信息，请参阅错误 99497，其中 WPF
        ///     默认情况下没有正确的测量值。
